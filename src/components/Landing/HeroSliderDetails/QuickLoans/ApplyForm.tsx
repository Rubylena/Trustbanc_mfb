...
export default function ApplyForm() {
  return (
    <div className="tw-flex tw-my-24 tw-ml-6 md:tw-ml-14 tw-h-full ">
      <form
      ...
      >
        ...
        <div className="tw-mt-6 tw-space-y-10 tw-text-justify">
          <div className="tw-relative tw-flex tw-gap-x-2">
            ...
            />
            <label htmlFor="comments" className="tw-text-xs tw-text-[#FFA044]">
              I hereby consent that the information I supplied above are true. I
              hereby also agree that upon disbursement, the management fee and
              transfer fee should be deducted from the requested loan that is to
              be trasferred to my stated salary account and the repayment will
              be directly deducted from source via applicable Direct Debit
              Platform.
            </label>
          </div>
        </div>
