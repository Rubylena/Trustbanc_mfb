...
export const Footer = () => {
    return (
        <footer
            className="tw-flex tw-justify-center md:tw-justify-between tw-items-center tw-flex-wrap tw-py-2 tw-px-5 md:tw-py-3 md:tw-px-14 tw-text-white"
        ...
        >
            ...
            <div >
                <ul className="tw-flex tw-m-auto tw-items-center tw-gap-2 ">
