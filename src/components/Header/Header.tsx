...
const features = [
  ...
  { name: "Corporate", href: "/corporate-current" },
...
const help = [{ name: "Contact Us", href: "/contact" }];
        ...
        <Popover.Group className="tw-hidden lg:tw-flex tw-items-center lg:tw-gap-x-12">
                  ...
                  {features.map((item) => (
                    ...
                    >
                      <div className="tw-flex-auto">
                        <a
                          href={item.href}
                          className="tw-block tw-font-medium tw-text-gray-900"
                        >
                          {item.name}
          ...
          <div className="tw-bg-blue tw-text-center py-2 px-3 tw-rounded-lg tw-flex tw-items-center tw-justify-center gap-2">
            ...
            <a
              ...
              className="tw-text-sm tw-font-medium py-2 tw-text-white"
            >
              Internet Banking
            </a>
          </div>
      ...
      >
        ...
        <Dialog.Panel className="tw-fixed tw-inset-y-0 tw-right-0 tw-z-10 tw-w-full tw-overflow-y-auto tw-bg-white tw-px-6 tw-py-6 sm:tw-max-w-sm ">
          <div className="tw-flex tw-items-center tw-justify-between">
            <a href="/" className="-tw-m-1.5 tw-p-1.5">
              <span className="tw-sr-only">TrustBanc MFB</span>
              <img className="tw-h-8 tw-w-auto" src={Images.logo} alt="" />
            </a>
            <button
              type="button"
